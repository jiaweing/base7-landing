    ...
    <FuzzyWrapper baseIntensity={1} className="w-full max-w-screen">
      <div className="relative">
        ...
        >
          ...
          >
            <path
              d="M40.5 13.5141V12.6641H38.765V13.1141H37.577V18.8271L42.127 18.8771V13.5141H40.5ZM37.575 9.37606V9.43906H39.863V10.3141H38.452V10.5011H37.577V11.9641H42.127V9.16406L37.575 9.37606Z"
              fill={color}
            />
          </motion.g>
